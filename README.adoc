...
there are lots of https://github.com/FasterXML/jackson-annotations/wiki/Jackson-Annotations[annotations] to tell Jackson how to deal with it.

The standard Java serialization using e.g. the `java.io.Serializable` interface is not used within Spring WebFlux.
