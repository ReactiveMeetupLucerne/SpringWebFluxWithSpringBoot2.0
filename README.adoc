...
Is this somehow different than in the "inside same process" example
...
with a delay of 2 seconds. The client aborts its call after 1 second using the timeout operator.
