...
the hotel and the car "in parallel"? Is this somehow different than in the "inside same process" example
in link:./src/main/java/a_intro/RxJavaCodeExamples.java[RxJavaCodeExamples.java]
|TODO
|TODO
